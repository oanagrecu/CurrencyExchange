...
const dataURL =
	// 'http://api.exchangeratesapi.io/v1/latest?access_key=e8b69b56f0ec19647cb1b59cd542e3a8&format=1';

const initiallyDisplayedCurrencies = ['USD', 'EUR', 'GBP'];
let baseCurrency;
...
function getTime(event) {
	...
	time.innerHTML = humanDateFormat;
}
